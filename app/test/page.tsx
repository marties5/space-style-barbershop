...
export default function TestPage() {
  ...
  const [permissionTests, setPermissionTests] = useState<TestResult | null>(
    null
  );
      ...
      <div className="min-h-screen flex items-center justify-center p-4">
        <Card className="w-full max-w-md">
          <CardHeader className="text-center">
            ...
            <CardDescription>
              Please sign in to run integration tests
            </CardDescription>
          </CardHeader>
        </Card>
      </div>
  ...
  return (
    <div className="min-h-screen bg-background p-6 mb-16">
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <Card>
          ...
          <CardContent>
            <div className="flex flex-wrap gap-4">
              ...
              <Button
                onClick={runAllTests}
                disabled={isTestingDatabase || isTestingPermissions}
                variant="outline"
              >
                Run All Tests
              </Button>
        ...
        {databaseTests && (
          <Card>
            ...
            <CardContent>
              <Alert
                className={
                  databaseTests.success ? "border-green-200" : "border-red-200"
                }
              >
                <AlertDescription>{databaseTests.message}</AlertDescription>
              </Alert>
              <div className="mt-4 space-y-2">
                {Object.entries(databaseTests.tests).map(
                  ([testName, passed]) => (
                    <div
                      key={testName}
        ...
        {permissionTests && (
          <Card>
            ...
            <CardContent>
              ...
              <div className="mt-4 space-y-2">
                {Object.entries(permissionTests.tests).map(
                  ([testName, passed]) => (
                    <div
                      key={testName}
                      className="flex items-center justify-between p-2 border border-border rounded"
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Overall system health and integration status
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <div className="flex items-center justify-between p-3 border border-border rounded">
                ...
                <Badge
                  variant="secondary"
                  className={
                    databaseTests?.tests.userSyncWorks
                      ? "bg-green-100 text-green-800"
                      : "bg-gray-100 text-gray-800"
                  }
                >
